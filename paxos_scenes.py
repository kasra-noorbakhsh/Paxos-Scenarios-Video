...
class PaxosAnimation(Scene):
    def construct(self):
        def create_acceptors():
            acceptors = VGroup(*[
                Circle(radius=0.5, color=GREEN).shift(RIGHT * (i * 2 - 2)) for i in range(3)
            ])
            acc_txts = VGroup(*[
        ...
        title1 = Text("Scenario 1: Single Proposer (No Conflict)", font_size=36).to_edge(UP, buff=0.5)
        self.play(Write(title1))
        self.wait(1)

        proposer = Circle(radius=0.5, color=BLUE).shift(LEFT * 4)
        proposer_txt = Text("Proposer P1", font_size=24).next_to(proposer, DOWN, buff=0.3)
        acceptors, acc_txts = create_acceptors()
        learner = Circle(radius=0.5, color=YELLOW).shift(DOWN * 3)
        learner_txt = Text("Learner", font_size=24).next_to(learner, DOWN, buff=0.3)
        ...
        for acc in acceptors:
            ...
            lbl = Text("Prepare: #1", font_size=20).next_to(arr, UP, buff=0.2)
        ...
        for acc in acceptors:
            ...
            lbl = Text("Promise", font_size=20).next_to(arr, DOWN, buff=0.2)
        ...
        for acc in acceptors:
            ...
            lbl = Text("Accept: v=42", font_size=20).next_to(arr, UP, buff=0.2)
        ...
        for acc in acceptors:
            ...
            lbl = Text("Accepted", font_size=20).next_to(arr, LEFT, buff=0.2)
            learn_arrows.add(arr)
            learn_labels.add(lbl)
            self.play(GrowArrow(arr), Write(lbl), run_time=1)
        self.wait(1)

        result1 = Text("Value 42 chosen", font_size=28, color=YELLOW).next_to(learner, DOWN, buff=0.5)
        ...
        title2 = Text("Scenario 2: Two Proposers Competing", font_size=36).to_edge(UP, buff=0.5)
        self.play(Write(title2))
        self.wait(1)

        p1 = Circle(radius=0.5, color=BLUE).shift(LEFT * 4 + DOWN * 1)
        p2 = Circle(radius=0.5, color=RED).shift(LEFT * 4 + UP * 1)
        p1_txt = Text("P1 (#1)", font_size=24).next_to(p1, DOWN, buff=0.3)
        p2_txt = Text("P2 (#2)", font_size=24).next_to(p2, UP, buff=0.3)
        acceptors, acc_txts = create_acceptors()
        ...
        for acc in acceptors:
            ...
            lbl = Text("P1: Prepare #1", font_size=20).next_to(arr, UP, buff=0.2)
        ...
        for acc in acceptors:
            arr = Arrow(p2.get_right(), acc.get_left(), buff=0.2, color=RED)
            lbl = Text("P2: Prepare #2", font_size=20).next_to(arr, UP, buff=0.2).shift(UP * 0.4)
        ...
        promise_labels = VGroup()
        for acc in acceptors:
            arr = Arrow(acc.get_left(), p2.get_right(), buff=0.2, color=RED)
            lbl = Text("Promise", font_size=20).next_to(arr, DOWN, buff=0.2)
            promise_arrows.add(arr)
            promise_labels.add(lbl)
            self.play(GrowArrow(arr), Write(lbl), run_time=1)
        ...
        for acc in acceptors:
            arr = Arrow(p2.get_right(), acc.get_left(), buff=0.2, color=RED)
            lbl = Text("Accept: v=84", font_size=20).next_to(arr, UP, buff=0.2)
            accept_arrows.add(arr)
            accept_labels.add(lbl)
            self.play(GrowArrow(arr), Write(lbl), run_time=1)
        self.wait(1)

        result2 = Text("P2 wins: Value 84 chosen", font_size=28, color=RED).shift(DOWN * 3)
        ...
        title3 = Text("Scenario 3: Proposer Failure & Recovery", font_size=36).to_edge(UP, buff=0.5)
        ...
        p1_txt = Text("P1 (#1)", font_size=24).next_to(p1, DOWN, buff=0.3)
        p2_txt = Text("P2 (#2)", font_size=24).next_to(p2, DOWN, buff=0.3)
        acceptors, acc_txts = create_acceptors()
        ...
        for acc in acceptors:
            ...
            lbl = Text("P2: Prepare #2", font_size=20).next_to(arr, DOWN, buff=0.2)
            p2_prepare_arrows.add(arr)
            p2_prepare_labels.add(lbl)
            self.play(GrowArrow(arr), Write(lbl), run_time=1)
        self.wait(1)
        ...
        for acc in acceptors:
            arr = Arrow(p2.get_left(), acc.get_right(), buff=0.2, color=RED)
            lbl = Text("P2: Accept v=99", font_size=20).next_to(arr, UP, buff=0.2)
            accept_arrows.add(arr)
            accept_labels.add(lbl)
            self.play(GrowArrow(arr), Write(lbl), run_time=1)
        self.wait(1)

        result3 = Text("P2 recovers: Value 99 chosen", font_size=28, color=RED).shift(DOWN * 3)
        ...
        title4 = Text("Discussion: Paxos Guarantees", font_size=36).to_edge(UP, buff=0.5)
        ...
        bullets = VGroup(*[
            Text(line, font_size=28).to_edge(LEFT, buff=1).shift(DOWN * (i * 0.8 + 1))
        ...
        thanks = Text("Thanks for watching!", font_size=32, color=YELLOW).to_edge(DOWN, buff=0.5)
